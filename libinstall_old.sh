...
STANDARD_EXCEPTIONS="Sensors|dspci|WhateverName"
if [[ "$EXCEPTIONS" == "" ]]; then
...
# {
#     install_kext downloads/kexts/RehabMan-FakePCIID*/Release/FakePCIID.kext
#     install_kext downloads/kexts/RehabMan-FakePCIID*/Release/FakePCIID_Intel_HDMI_Audio.kext
# }

# function install_fakepciid_xhcimux
# {
#     install_kext downloads/kexts/RehabMan-FakePCIID*/Release/FakePCIID.kext
#     install_kext downloads/kexts/RehabMan-FakePCIID*/Release/FakePCIID_XHCIMux.kext
# }
...
#         if [[ -e $(echo downloads/kexts/RehabMan-BacklightFixup*/Release/AppleBacklightFixup.kext) ]]; then
#             install_kext downloads/kexts/RehabMan-BacklightFixup*/Release/AppleBacklightFixup.kext
...
#     else
#         install_kext downloads/kexts/RehabMan-IntelBacklight*/Release/IntelBacklight.kext
#         remove_kext AppleBacklightInjector.kext
#         remove_kext AppleBacklightFixup.kext
#     fi
# }

function install_fakesmc_sensor_kexts_rehabman
{
    install_kext downloads/kexts/RehabMan-FakeSMC*/FakeSMC_ACPISensors.kext
    install_kext downloads/kexts/RehabMan-FakeSMC*/FakeSMC_CPUSensors.kext
    install_kext downloads/kexts/RehabMan-FakeSMC*/FakeSMC_GPUSensors.kext
    install_kext downloads/kexts/RehabMan-FakeSMC*/FakeSMC_LPCSensors.kext
    install_kext downloads/kexts/RehabMan-FakeSMC*/FakeSMC_SMMSensors.kext
}

function install_fakesmc_sensor_kexts
{
    install_kext downloads/kexts/fakesmc-*/FakeSMC_ACPISensors.kext
    install_kext downloads/kexts/fakesmc-*/FakeSMC_CPUSensors.kext
    install_kext downloads/kexts/fakesmc-*/FakeSMC_GPUSensors.kext
    install_kext downloads/kexts/fakesmc-*/FakeSMC_LPCSensors.kext
}
...
{
    lilufriend_creator "$(dirname ${BASH_SOURCE[0]})"/template_kexts/LiluFriendTemplate.kext LiluFriend.kext
}

function create_and_install_lilufriendlite
{
    lilufriend_creator "$(dirname ${BASH_SOURCE[0]})"/template_kexts/LiluFriendLiteTemplate.kext LiluFriendLite.kext
}
